<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            <x-input-label for="username" :value="'Email or NIK'" />
    ...
    <!-- Modal Pop-Up Error -->
    <div id="error-modal"
        class="fixed inset-0 bg-gray-800 bg-opacity-75 flex-justify-center items-center hidden z-50 transition-opacity duration-300">
        <div
            class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md transform transition-all duration-300 ease-in-out">
            <div class="flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    <button onclick="closeModal()"
                        class="bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg w-full font-medium transition-colors duration-200 transform hover:scale-105">
                        OK
                    </button>
                </div>
            </div>
