...
@section('js')
    ...
    <script>
        ...
        // Menyembunyikan tombol awal dan menampilkan halaman presensi saat tombol ditekan
        document.getElementById('btn-start').addEventListener('click', function() {
            document.getElementById('initial-screen').style.display = 'none'; // Menyembunyikan tombol 'Mulai'
            document.getElementById('presensi-screen').style.display = 'block'; // Menampilkan bagian presensi

            // Inisialisasi webcam setelah menampilkan halaman presensi
...
@section('container')
    <div id="initial-screen">
        <button id="btn-start" class="btn btn-primary text-white">
            Mulai Presensi
        </button>
        <div>
                                    ...
                                    <tbody>
                                        @foreach ($riwayatPresensi as $value => $item)
                                            <tr class="hover">
                                                ...
                                                <td
                                                    class="{{ $item->jam_masuk < '08:00' ? 'text-success' : 'text-error' }}">
    ...
    <div id="presensi-screen" style="display: none;">
