        ...
        <div :class="{'w-64': !open, 'w-16': open}" class="fixed inset-y-0 left-0 bg-blue-800 text-white z-30 transition-all duration-300">
            ...
            <div class="py-4 space-y-1">
                <x-sidebar-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                    <i class="ri-tv-2-line mr-2"></i> {{ __('Dashboard') }}
                </x-sidebar-link>
                ...
                <x-sidebar-link :href="route('jadwal-shift.index')" :active="request()->routeIs('jadwal-shift.index')">
                    <i class="ri-calendar-line mr-2"></i> {{ __('Jadwal') }}
                </x-sidebar-link>
                                                ...
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="flex-1">
                                                        <p class="text-sm font-medium text-gray-900">
                                                            {{ $exchange->pengaju ? $exchange->pengaju->nama_lengkap : '[Dihapus]' }} ↔ {{ $exchange->penerima ? $exchange->penerima->nama_lengkap : '[Dihapus]' }}
                                                        </p>
