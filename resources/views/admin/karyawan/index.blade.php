                ...
                <form action="{{ route('admin.karyawan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="form-control w-full">
                        ...
                        <input type="text" name="nik" placeholder="NIK"
                            class="input input-bordered w-full text-blue-700" value="{{ old('nik') }}" required />
                        @error('nik')
                            <div class="label">
                    ...
                    <label class="form-control w-full">
                        ...
                        <select name="departemen_id" class="select select-bordered w-full text-blue-700">
                            ...
                            @foreach ($departemen as $item)
                                <option value="{{ $item->id }}" @if ($item->id == old('departemen_id')) selected @endif>
                                    {{ $item->nama }}</option>
                            @endforeach
                        </select>
                        @error('departemen_id')
                    ...
                    <label class="form-control w-full">
                        ...
                        <input type="text" name="nama_lengkap" placeholder="Nama Lengkap"
                            class="input input-bordered w-full text-blue-700" value="{{ old('nama_lengkap') }}"
                            required />
                        @error('nama_lengkap')
                            <div class="label">
                                <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                    ...
                    <label class="form-control w-full">
                        ...
                        <input type="text" name="jabatan" placeholder="Jabatan"
                            class="input input-bordered w-full text-blue-700" value="{{ old('jabatan') }}" required />
                        @error('jabatan')
                            <div class="label">
                                <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                            </div>
                    ...
                    <label class="form-control w-full">
                        ...
                        <input type="password" name="password" placeholder="Password"
                            class="input input-bordered w-full text-blue-700" value="{{ old('password') }}"
                            required />
                        @error('password')
                            <div class="label">
                                <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                ...
                <form action="{{ route('admin.karyawan.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="form-control w-full">
                        ...
                        <select name="departemen_id" id='departemen_id'
                            class="select select-bordered w-full text-blue-700">
                        </select>
                        @error('departemen_id')
                            <div class="label">
                                <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                    ...
                    <button type="submit"
                        class="btn btn-warning form-control w-full text-slate-700">Perbarui</button>
                </form>
            </div>
        </div>
    </div>
                ...
                success: function(data) {
                    ...
                    if (items[3] != null) {
                        $(".foto-edit-preview").attr("src",
                            `{{ asset('storage/unggah/karyawan/${items[3]}') }}`);
                    } else {
                        $(".foto-edit-preview").attr("src", ``);
                    }
